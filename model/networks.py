...
def define_G(opt):
    ...
    elif model_opt['which_model_G'] == 'wave':
        from .wave_modules import diffusion, unet
    elif model_opt['which_model_G'] == 'wave_only':
        from .wave_modules_abl_wave_only import diffusion, unet
    elif model_opt['which_model_G'] == 'baseline':
